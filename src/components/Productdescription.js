...
class ProductDescription extends React.Component {
    ...
    render() {
        const cartProductIds = this.state.cart.map(
                    ...
                    <div className="pro-desc-outer-box">
                        <div className="pro-desc-img-box">
                            <div className="pro-desc-disp-img1">
                                <div id="pro-desc-disp-img">
                                    <img
                                        className="all-imgs gen-img"
                                        data-src={`${productData?.images[0]}.jpg`}
                                        alt="img"
                                    />
                                </div>
                            </div>
                            <div id="img-othrs" className="pro-desc-disp-img1">
                                ...
                                <div
                                    key={productData?.images[1]}
                                    className="pdtn"
                                >
                                    <img
                                        className="all-imgs gen-img"
                                        data-src={`${productData?.images[1]}.jpg`}
                                        onError={(e) => {
                                            e.target.onerror = null;
                                            e.target.src =
                                                "../images/default.png";
                                ...
                                <div
                                    key={productData?.images[2]}
                                    className="pdtn"
                                >
                                    <img
                                        className="all-imgs gen-img"
                                        data-src={`${productData?.images[2]}.jpg`}
                                        onError={(e) => {
                                            e.target.onerror = null;
                                            e.target.src =
                                                "../images/default.png";
                                ...
                                <div
                                    key={productData?.images[3]}
                                    className="pdtn"
                                >
                                    <img
                                        className="all-imgs gen-img"
                                        data-src={`${productData?.images[3]}.jpg`}
                                        onError={(e) => {
                                            e.target.onerror = null;
                                            e.target.src =
                                                "../images/default.png";
                        ...
                        <div className="pro-desc-det-box">
                            ...
                            >
                                ...
                                <option htmlFor="quantity" value="2">
                                    2
                                </option>
                                <option htmlFor="quantity" value="3">
                                    3
                                </option>
                                <option htmlFor="quantity" value="4">
                                    4
                                </option>
                                <option htmlFor="quantity" value="5">
                                    5
                                </option>
                            </select>
                            <div className="des-btn-box">
                                {cartProductIds.includes(
                                    ...
                                    <Link to="/cart">
                                        <button className="prd-des-btn prd-dec-add-btn">
                                            Add to Cart
                                        </button>
                                    </Link>
                                ) : (
                                    <button
                                        className="prd-des-btn prd-dec-add-btn"
                                ...
                                {cartProductIds.includes(
                                    ...
                                    <Link to="/cart">
                                        <button className="prd-des-btn prd-dec-buy-btn">
                                            Buy Now
                                        </button>
                                    </Link>
                                ) : (
                                    <button
                                        className="prd-des-btn prd-dec-buy-btn"
